...
public class Play_13 extends AppCompatActivity {
    ...
    public void p13clickCheck(View view) {
            ...
            c1 = (p13_et_1.getText().toString());
            c2 = (p13_et_2.getText().toString());
            c3 = (p13_et_3.getText().toString());
            c4 = (p13_et_4.getText().toString());
            if(c1.equals("")||c2.equals("")||c3.equals("")||c4.equals("")) {
                ...
                try {
                    ...
                    if (e1 == a1 && e2 == a2 && e3 == a3 && e4 == a4) {
                        ...
                        int p13 ;
                        c.moveToFirst();
                        p13 = c.getInt(c.getColumnIndex("p13"));
                        ...
                        if(p13 == 1) {
                            ...
                            score+=50;
                            db.execSQL("UPDATE users SET p13 = 1,score="+score+" WHERE username = '"+curr_user+"'");
