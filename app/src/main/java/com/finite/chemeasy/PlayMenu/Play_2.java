...
public class Play_2 extends AppCompatActivity {
    ...
    public void p2clickCheck(View view) {
        String c1 = "", c2 = "", c3 = "", c4 = "";
        view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
        c1 = (p2_et_1.getText().toString());
        c2 = (p2_et_2.getText().toString());
        c3 = (p2_et_3.getText().toString());
        //c4 = (p2_et_4.getText().toString());
        if (c1.equals("") || c2.equals("") || c3.equals("")) {
            ...
            try {
               ...
               // e4 = Integer.parseInt(p2_et_4.getText().toString());
                if (e1 == a1 && e2 == a2 && e3 == a3) {
                    ...
                    int p2 ;
                    c.moveToFirst();
                    p2 = c.getInt(c.getColumnIndex("p2"));
                    ...
                    if(p2 == 1) {
                        ...
                        score+=50;
                        db.execSQL("UPDATE users SET p2 = 1,score="+score+" WHERE username = '"+curr_user+"'");
