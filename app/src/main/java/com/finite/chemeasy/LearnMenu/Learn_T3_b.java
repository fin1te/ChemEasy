...
public class Learn_T3_b extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn__t3_b);
    }
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET t3b = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
