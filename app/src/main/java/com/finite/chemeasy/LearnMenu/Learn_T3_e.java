...
public class Learn_T3_e extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn__t3_e);
    }

    public void t3_e_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET t3e = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
