...
public class Learn_T4_a extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn__t4_a);
    }

    public void t4_a_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET t4a = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
