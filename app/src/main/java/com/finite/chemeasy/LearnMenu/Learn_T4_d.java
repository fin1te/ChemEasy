...
public class Learn_T4_d extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn__t4_d);
    }

    public void t4_d_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET t4d = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
