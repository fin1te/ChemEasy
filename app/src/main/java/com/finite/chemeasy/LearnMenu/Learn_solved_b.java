...
public class Learn_solved_b extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_solved_b);
    }

    public void ts_b_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET tsb = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
