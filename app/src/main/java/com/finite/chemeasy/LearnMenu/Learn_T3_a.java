...
public class Learn_T3_a extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn__t3_a);
    }

    public void t3_b_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET t3a = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
