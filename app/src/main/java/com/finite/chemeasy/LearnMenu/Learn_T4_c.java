...
public class Learn_T4_c extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn__t4_c);
    }

    public void t4_c_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET t4c = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
