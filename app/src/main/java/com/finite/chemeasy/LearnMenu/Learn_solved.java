...
public class Learn_solved extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_solved);
    }

    public void ts_clickDone(View view) {
...
//            c.moveToFirst();
            db.execSQL("UPDATE users SET ts = 1 WHERE username = '"+curr_user+"'");
        }
        catch(Exception e) {
